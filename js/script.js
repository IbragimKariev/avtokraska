...
$(".manufactures_slider").slick({
    ...
    arrows: true,
    dots: false,
    prevArrow: '<button id="prev" type="button" class="slider_btn slider_btn_prev"><img src="../img/icons/left_arrow.svg" alt=""></button>',
    nextArrow: '<button id="next" type="button" class="slider_btn slider_btn_next"><img src="../img/icons/right_arrow.svg" alt=""></button>',
    speed: 500,
    responsive: [{
        breakpoint: 500,
        settings: {
